package com.felipejansen.jhipster_flyway.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.felipejansen.jhipster_flyway.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.felipejansen.jhipster_flyway.repository.UserRepository.USERS_BY_EMAIL_CACHE);
